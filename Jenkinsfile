    ...
    stages {
        ...
        stage('API Test') {
            ...
            steps {
                ...
                sh 'newman run $FOLDER/Tests.postman_collection.json -g $FOLDER/workspace.postman_globals.json --env-var "baseUrl=$TOMCAT_SERVER:$PORT/$APP" --disable-unicode --reporters cli,html,junit --reporter-html-export "target/pipelineReport.html"'                
            }       
        }   
    }
 post { 
